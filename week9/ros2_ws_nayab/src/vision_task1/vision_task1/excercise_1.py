...
class CameraFollower(Node):
    def __init__(self):
        ...
        # 🔵 HSV Thresholds for BLUE OBJECT (ONLY CHANGE FOR EXERCISE 1)
        self.lower_color = np.array([100, 150, 50])
        self.upper_color = np.array([140, 255, 255])

        self.get_logger().info("Blue Object Tracking Node Started")
    ...
    def image_callback(self, msg):
        ...
        if valid_contours:
            ...
            self.get_logger().info("[SEARCHING] No blue object detected")
